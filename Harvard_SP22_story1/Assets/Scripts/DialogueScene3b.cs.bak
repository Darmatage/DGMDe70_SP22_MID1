...
public void talking(){         // main story function. Players hit next to progress to next int
        ...
        if (primeInt == 1){
                ...
                Char1name.text = "Jason";
                Char1speech.text = "(I took the scroll from the Game Object...)";
                Char2name.text = "";
                Char2speech.text = "";
                Char3name.text = "";
                Char3speech.text = "";
                ...
                Char3speech.text = "";
                 ...
                 Char3speech.text = "";
                  ...
                  Char1name.text = "Jason";
                  Char1speech.text = "(I'm starting to doubt my decision to listen to the game objects...)";
                  Char2name.text = "";
                  Char2speech.text = "";
                  Char3name.text = "";
                  Char3speech.text = "";
                  ...
                  Char1name.text = "Jason";
                  Char1speech.text = "(If it's so powerful, why didn't they use this scroll themselves?)";
                  Char2name.text = "";
                  Char2speech.text = "";
                  Char3name.text = "";
                  Char3speech.text = "";
                  ...
                  Char1name.text = "Jason";
                  Char1speech.text = "Yes, yes, Cubey, we will assist each other until the very end.";
                  Char2name.text = "";
                  Char2speech.text = "";
                  Char3name.text = "";
                  Char3speech.text = "";
                  ...
                  Char1name.text = "Jason";
                  Char1speech.text = "(Despite the very annoying way Cubey is programmed to speak in... He's surprisingly wholesome.)";
                  Char2name.text = "";
                  Char2speech.text = "";
                  Char3name.text = "";
                  Char3speech.text = "";
