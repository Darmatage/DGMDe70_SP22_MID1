...
public void talking(){         // main story function. Players hit next to progress to next int
        ...
        if (primeInt == 1){
                ...
                Char1speech.text = "(As I cautiously enter the depths of this cave, dripping with strange text...)";
                Char2name.text = "";
                Char2speech.text = "";
        }
        else if (primeInt == 3){
                Char1name.text = "Jason";
                Char1speech.text = "(the eerie red glow becomes stronger and stronger.)";
                Char2name.text = "";
                Char2speech.text = "";
                ...
                Char1name.text = "Jason";
                Char1speech.text = "(A large bulbous head with four… no, five limbs holding it up...)";
                Char2name.text = "";
                Char2speech.text = "";
        }
        else if (primeInt == 9){
                 Char1name.text = "Jason";
                 Char1speech.text = "(A strane creature indeed...)";
                 Char2name.text = "";
                 Char2speech.text = "";
         }
         else if (primeInt == 10){
                  ...
                  Char1name.text = "Jason";
                  Char1speech.text = "I’ve got the jump on it…";
                  Char2name.text = "";
                  Char2speech.text = "";
          }
          else if (primeInt == 14){
